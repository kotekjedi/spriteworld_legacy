...
class AbstractDistribution(object):
  ...
  @abc.abstractmethod
  def sample(self,uniform=None, rng=None):
...
class Mixture(AbstractDistribution):
  ...
  def sample(self,uniform=None, rng=None):
    ...
    sample = self.components[sample_index].sample(uniform=None,rng=rng)
    return sample
...
class Intersection(AbstractDistribution):
  ...
  def sample(self,uniform=None, rng=None):
    ...
    while tries < _MAX_TRIES:
      tries += 1
      sample = self.components[self.index_for_sampling].sample(uniform=None,rng=rng)
...
class Product(AbstractDistribution):
  ...
  def sample(self,uniform=None, rng=None):
    ...
    for c in self.components:
      sample.update(c.sample(uniform=None,rng=rng))
    return sample
...
class SetMinus(AbstractDistribution):
  ...
  def sample(self,uniform=None, rng=None):
    ...
    while tries < _MAX_TRIES:
      tries += 1
      sample = self.base.sample(uniform=None,rng=rng)
